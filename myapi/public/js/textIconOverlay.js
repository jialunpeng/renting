...
(function () {
    ...
    */
    TextIconOverlay.prototype._updateText = function(){
        if (this._domElement) {
            this._domElement.innerHTML = this._text + '套';
        }
    };
    ...
    */
    TextIconOverlay.prototype._buildCssText = function(style) {
        ...
        var background = style['background'] || 'none';
        var borderRadius = style['borderRadius'] ? '50%': 'inherit' ;
        ...
        if (T.browser["ie"] < 7) {
            ...
            csstext.push('background:' + background +';');
        ...
        csstext.push('cursor:pointer; color:' + textColor + '; position:absolute; font-size:' +
            textSize + 'px; font-family:Arial,sans-serif; font-weight:bold' + '; border-radius:' + borderRadius + ';');
        return csstext.join('');
    };
